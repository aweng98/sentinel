...
object AppController extends Controller {
  ...
  object configuration {
    ...
    private val dateValidationThresholdSec = Play.application.configuration.
      getInt(DATE_VALIDATE_THRESHOLD_SEC_KEY)
     ...
     * be validated against the server's current (UTC) time to be not older than [[validationThresholdSec]]
     * seconds.
     *
